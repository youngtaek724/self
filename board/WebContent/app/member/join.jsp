               ...
               <div class="wrapper">
                  <div class="inner">
                     ...
                     <section class="main">
                        ...
                        <header class="major">
                           <a href="javascript:void(0)" class="image main"><img src="${pageContext.request.contextPath}/assets/images/join01.png"/></a>
                           <h1>회원가입</h1>
                           <p>
                              환영합니다 고객님<br>
                           ...
                           <div style="display:flex; justify-content:space-around;">
                              <div style="width:40%">
                                 <p style="background:#fd3a3a2e"><span style="color:red; font-size:2rem; font-weight:bold;">*</span>아래 항목은 모두 작성해주세요.</p>
                                    <div>
                                       <div class="col-6 col-12-xsmall" style="width:100%">
                                          ...
                                          <input type="text" name="" id="memberId" placeholder="6자 이상의 영문 혹은 영문과 숫자를 조합" />
                                          <br>
                                          <p style="margin:0;">비밀번호</p>
                                          <input type="password" name="" id="" placeholder="영문 4자 이상, 최대 20자"/>
                                          <br>
                                    ...
                                    <div style="display:flex;">
                                       <input type="text" name="" id="memberZipcode" placeholder="우편번호">
                                       <input type="button" onclick="find()" value="우편번호 찾기"><br>
                                    </div>
                                    <br>
                                    <input type="text" name="" id="memberAddress" placeholder="주소">
                                    <input type="text" name="" id="memberAddressDetail" placeholder="상세주소">
                                 ...
                                 <div class="preview" style="width:40%">
									<div>
										<h4>광고1</h4>
										<img src="${pageContext.request.contextPath}/assets/images/ex01.png">
									</div>
									<hr>
									<div>
										<h4>광고2</h4>
										<img src="${pageContext.request.contextPath}/assets/images/ex03.png">
									</div>
									<hr>
									<div>
										<h4>광고3</h4>
